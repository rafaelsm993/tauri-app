...
test("notes do not describe removed features", () => {
  const banned = [
    "UserButton", "WatchlistButton", "userStore", "CloudAPI", "AuthAPI",
    "WatchlistAPI", "rusqlite", "DbConn", "tauri-app_server",
    "VITE_CLOUD_API_URL", "auth_login", "/watchlist", "/auth", "vscode-file://",
  ];
  for (const f of ALL) {
